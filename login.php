...
<header>
   ...
   <a href="#" class="logo"><i class="fas fa-hamburger"></i>A&Z Fast-Food<i class="fas fa-drumstick-bite"></i></a>
    ...
    <nav class="navbar">
        ...
        <a href="home.php#dishes">dishes</a>
        <a  href="home.phpabout.php">about Us</a>
    ...
    <div class="icons">
		...
		<i  href="#" class="fas fa-user" id="user"></i>
...
<div class="kotak" id="kotak">
	<div class="form-kotak sign-up-kotak">
		<form action="#">
			<h1>Create Account</h1>
			<div class="social-kotak">
