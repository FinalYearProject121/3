...
<?php
		...
		$result = mysqli_query($con,"SELECT * FROM FOOD WHERE food_type='special' AND food_status='yes'");
 ...
 ?>
        ...
        <div class="box">
			...
			<?php 
				$result3 = mysqli_query($con,"SELECT * FROM WISHLIST WHERE food_id='" . $foodID2 . " ' AND cust_id='" . $custID . "' ");
				if ($result3->num_rows > 0) {
				?> 
				
					<a style="color:#fff;background: maroon;" href="wishlistDelete.php?foodID=<?php echo $row['food_id'];  ?>" class="fas fa-heart"></a> 
				
				<?php
				}else { 
				?>
				
					<a href="wishlistInsert.php?foodID=<?php echo $row['food_id'];  ?>" class="fas fa-heart"></a>
...
<?php
		...
		$result = mysqli_query($con,"SELECT * FROM FOOD WHERE food_type='main' AND food_status='yes'");
 ...
 ?>
        ...
        <div class="box">
            <div class="image">
				...
				<?php 
				$result2 = mysqli_query($con,"SELECT * FROM WISHLIST WHERE food_id='" . $foodID1 . " ' AND cust_id='" . $custID . "' ");
  ...
  .loginPopup {
	...
	<div  class="loginPopup">
      <div class="formPopup" id="popupForm">
        <form action="cartInsert.php" method="post" class="formContainer">
