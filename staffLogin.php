...
body 
	  {
      background: url("images/staff2.jpg") no-repeat center;
...
<div class="login">
  <div style="background-color:#f9cd86;" class="form">
    <form action="staffLogin2.php" method="post" class="login-form">
      <span style="color:maroon;" class="material-icons">Staff</span>
	  <!--letak dkt input format email == pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" -->
      <input name="username" type="text" placeholder="username" required  />
      <input name="password" type="password" placeholder="password" required />
      <button type="submit" style="background-color:maroon;color:white;" >login</button>
    </form>  
  </div>
</div>
