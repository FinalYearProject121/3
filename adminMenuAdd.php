...
<header>
    ...
    <nav class="navbar">
        ...
        <a style="color:#fff;background: maroon;" href="adminMenuAdd.php">Add Menu</a>
...
<br><br><br>
 <div class="main-block">
      <div class="left-part">
        <i    class="fas fa-hamburger fa-10x"></i>
        <i class="fas fa-drumstick-bite fa-10x"></i>
        <p style="font-size:40px;"><b> ADD NEW MENU </b> </p>
        
      </div>
      <form action="adminMenuAddNew.php" method="post">
       
        <div style="width:400px;" class="info" >
          
          <b  >Name</b> <input type="text" name="name" required > 
          <b style="margin-top:-20px;" >Price</b><input type="text" name="price" required >
          <b style="margin-top:-20px;" >Image</b><input type="file" name="image" accept="image/*" required >
		  <b style="margin-top:-20px;" >Description</b><input type="text" name="description"  required  >
		  <b style="margin-top:-20px;" >Calories (ex:200 cals)</b><input type="text" name="calories"  required  >
		  <b style="margin-top:-20px;" >Status (yes/no)</b>
		  <select name="status" required >
			<option value="yes">Yes</option>
			<option value="no">No</option>
		  </select>
		  
		  <b style="margin-top:-20px;" >Type (special/main)</b> 
