...
<header>
    ...
    <nav class="navbar">
        <a  href="staffMain2.php">Ready Order to Pickup</a>
	...
	<div class="icons">
		...
		<a style="color:#fff;background: maroon;" href="staffProfile2.php" class="fas fa-user" id="user"></a>
...
<br><br><br>
 <div class="main-block">
      ...
      <form action="staffProfileUpdate2.php" method="post">
