...
<header>
    ...
    <a href="#" class="logo"><i class="fas fa-hamburger"></i>A&Z Fast-Food<i class="fas fa-drumstick-bite"></i>(staff - delivery)</a>

    <nav class="navbar">
        <a style="color:#fff;background: maroon;" href="staffMain2.php">Ready Order to Pickup</a>
         <a href="staffComplete.php">Complete Order</a>
		<a href="stafflogout.php">Logout</a>
    </nav>

	<div class="icons">
        <i class="fas fa-bars" id="menu-bars"></i>
		<a  href="staffProfile2.php" class="fas fa-user" id="user"></a>
...
<section class="dishes"  style ="background-color: #FCF3CF;">
 ...
 <h1 style="font-size:300%">Order Detail <span style="font-size:20px;">(Deliver by : <?php  echo $username;  ?> )</span></h1> 
 
 <h2> (New Order to PickUp)</h2>
...
<table>
  <tr>
    ...
    <?php
		...
		$sqlz = mysqli_query($con,"SELECT * FROM ORD WHERE ord_status='ReadyToPickup' ORDER BY ord_datetime DESC");
  ...
  <tr>
	...
	?>
	 ...
	 <td><?php echo $OrdSta;  ?></td> 
	   <form action="staffPickUp.php" method="post" >
	   <input type="hidden" name="orderID" value="<?php echo $OrdID; ?>" />
	 <td><center><button style="background-color: #228c22;"   type="submit" class="btn">PickUp Order</button></center></td>
  </form>
  </tr>     
	 <?php
			}
...
<table>
  <tr>
    ...
    <?php
		...
		$sqlz = mysqli_query($con,"SELECT * FROM ORD WHERE ord_status='OutToDelivery' ORDER BY ord_datetime DESC");
  ...
  <tr>
	...
	?>
	 ...
	 <td>RM<?php echo $OrdTOTAL;  ?></td>
	 <td><?php echo $OrdSta;  ?></td> 
	   <form action="staffPickUptoComplete.php" method="post" >
	   <input type="hidden" name="orderID" value="<?php echo $OrdID; ?>" />
	 <td><center><button style="background-color: #228c22;"   type="submit" class="btn">Complete Order</button></center></td>
  </form>
  </tr>     
	 <?php
			}
