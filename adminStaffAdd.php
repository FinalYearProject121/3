...
<header>
    ...
    <nav class="navbar">
		...
		<a style="color:#fff;background: maroon;" href="adminStaffAdd.php">Add Staff</a>
...
<br><br><br>
 <div class="main-block">
      <div class="left-part">
        ...
        <p style="font-size:40px;"><b> ADD NEW STAFF </b> </p>
        
      </div>
      <form action="adminStaffAddNew.php" method="post">
        ...
        <div style="width:400px;" class="info" >
          ...
          <b>Phone Number</b><input type="text" name="phone" required >
          ...
          <b>Password</b><input type="password" name="password"   id="pass" required>
