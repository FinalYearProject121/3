...
<header>
    ...
    <nav class="navbar">
        <a  href="staffMain.php">New Order to Prepare</a>
         <a style="color:#fff;background: maroon;" href="staffReadyOrder.php">Order ready to Delivery</a>
...
<table>
  <tr>
    ...
    <?php
		...
		$sqlz = mysqli_query($con,"SELECT * FROM ORD WHERE ord_status='ReadyToPickup' AND staff_id='" . $staffID . "' ORDER BY ord_datetime DESC");
